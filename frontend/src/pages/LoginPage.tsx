        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="bg-card rounded-2xl shadow-lg border border-border p-8">
            ...
            <div className="mt-6">
              ...
              <button className="mt-4 w-full flex items-center justify-center gap-3 py-3 rounded-xl border border-border bg-background font-body text-sm font-medium text-foreground hover:bg-muted transition-colors">
