    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="section-padding -mt-16 relative z-10">
        ...
        <h2 className="font-heading text-xl font-semibold text-foreground mb-4 flex items-center gap-2">
          <Store className="h-5 w-5 text-primary" /> Products (
                ...
                <Card className="border border-border shadow-sm hover:shadow-md transition-all group cursor-pointer">
                  <CardContent className="p-3">
                    <img
                      src={product.image}
                      alt={product.name}
                      className="w-full aspect-square rounded-lg object-cover bg-muted mb-2 group-hover:scale-[1.02] transition-transform"
                    />
