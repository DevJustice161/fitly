...
const Index = () => {
  ...
  return (
    <>
      <SEO
        title="Nigeria's Fashion Marketplace"
        description="Discover and shop clothing, shoes, accessories, and more from trusted Nigerian fashion vendors on Fitly.ng."
        url="/"
      />
          ...
          <div className="relative section-padding h-full flex items-center">
            <div className="max-w-xl animate-fade-in-up">
              ...
              <p className="font-body text-primary-foreground/80 text-base lg:text-lg mb-8 max-w-md leading-relaxed">
                Discover curated fashion from Nigeria's finest designers.
        ...
        <section className="gradient-gold py-16 lg:py-20">
          <div className="section-padding text-center">
            ...
            <p className="font-body text-primary-foreground/80 max-w-lg mx-auto mb-8">
              Join Nigeria's fastest-growing fashion marketplace. Reach
              thousands of customers, manage your store with ease.
            </p>
            <Link
              to={
                user
